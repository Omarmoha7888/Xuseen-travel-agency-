...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact-us" className="py-20 px-4 sm:px-6 lg:px-8 bg-[#0D0D0D] border-t border-white/5 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-[#141414] border border-white/10 space-y-2">
              ...
              <a href="mailto:balcadtravel@gmail.com" className="block text-xs sm:text-sm text-gray-300 hover:text-[#D4AF37] transition-colors">
                balcadtravel@gmail.com
              </a>
            </div>

            {/* WhatsApp Direct Chat Card */}
            <div className="p-5 rounded-2xl bg-gradient-to-r from-[#11241a] to-[#141414] border border-emerald-500/30 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 text-emerald-400 font-bold text-xs sm:text-sm">
                  <MessageSquare className="w-4 h-4" />
                  <span>WhatsApp Direct</span>
                </div>
                <span className="text-[10px] text-emerald-400/80 uppercase font-semibold">Live Support</span>
              </div>
              <p className="text-xs text-gray-300 leading-relaxed">
                Connect directly with our travel operations desk on WhatsApp for instant inquiries.
              </p>
              <a
                href="https://wa.me/252612483838"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-black text-xs font-bold transition-colors"
              >
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 rounded-3xl bg-[#141414] border border-[#D4AF37]/30 shadow-2xl space-y-6">
              <div>
              ...
              {isSuccess ? (
                <div className="p-6 rounded-2xl bg-[#181818] border border-[#D4AF37]/50 text-center space-y-3">
                  <CheckCircle2 className="w-10 h-10 text-[#D4AF37] mx-auto" />
                  <h4 className="font-cinzel text-base font-bold text-white">Message Sent Successfully</h4>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 px-6 rounded-xl bg-gradient-to-r from-[#F5D77F] via-[#D4AF37] to-[#B8860B] text-black font-bold text-xs sm:text-sm shadow-lg shadow-[#D4AF37]/30 hover:scale-[1.01] active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                  >
